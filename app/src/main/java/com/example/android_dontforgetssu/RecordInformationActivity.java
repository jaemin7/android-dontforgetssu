       ...
       Button button2 = findViewById(R.id.button2);
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(checkBoxChecked){
                    Intent promissoryNoteIntent = new Intent(RecordInformationActivity.this,PromissoryNoteActivity.class);
                    startActivity(promissoryNoteIntent);
                }else{
                    Intent homeIntent = new Intent(RecordInformationActivity.this, NavigationActivity.class);
        ...
        back_btn.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                Intent intent = new Intent(RecordInformationActivity.this, LendMoney2Activity.class);
